		...
		<table id="auth_table" class="table" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$auth->path}}</td>
					<td>
						<button class="btn btn-sm btn-primary" {{-- href = "/auth/edit/{{$auth->id}}" --}} title="Edit Authorization Role" data-toggle="modal" data-target="#m_edit_module"><i class="fa fa-users-cog"></i></button>
						<button class="btn btn-sm btn-primary" {{-- href = "/authItems/edit/{{$auth->id}}" --}} title="Edit Authorization Permission" data-toggle="modal" data-target="#m_edit_permission"><i class="fa fa-user-lock"></i></button>
						<button class="btn btn-sm btn-danger" href = "/auth/delete/{{$auth->id}}" title="Delete Module" data-toggle="modal" data-target="#"><i class="fa fa-minus"></i></button>
					</td>
				</tr>
				@endforeach
			</tbody>
